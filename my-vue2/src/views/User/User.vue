<template>
    <div class="user-header">
        <el-button type="primary" @click="hanldeAdd()">+新增</el-button>
            ...
            <el-form :inline="true" :model="formUser" ref="userForm">
                <el-row>
                    ...
                    <el-col :span="12">
                        ...
                        :rules="[{required:true,message:'年龄是必填项'},{type:'number',message:'填数字'}]">
                ...
                <el-form-item>
                        <el-button type="primary" @click="handlleCancel">取消</el-button>
    ...
    setup(){
        ...
        const handleClose = (done) => {
            ElMessageBox.confirm('确定关闭吗?')
                .then(() => {
                    proxy.$refs.userForm.resetFileds();
                done()
                })
                .catch(() => {
                // catch error
